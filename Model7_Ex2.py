...
def get_relation(spatial_array, object1, object2, use_cardinal_relation):
    ...
    if len(object1_itemindex[0]) == 0 or len(object1_itemindex[0]) == 0 or len(object2_itemindex[0]) == 0 or len(object2_itemindex[0]) == 0:
        return 'None'
...
class Model7(ccobra.CCobraModel):
    ...
    def __init__(self, name='Model7'):
        super(Model7, self).__init__(name, ['spatial-relational'], ['verify', 'single_choice'])
