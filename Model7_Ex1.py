...
"""
Returns all cardinal direction (inclusive inter cardinal directions) (marked and unmarked distance is not the same) (marked distance is larger than unmarked) (without random)
"""
class Model7(ccobra.CCobraModel):

    def __init__(self, name='Model7'):
        super(Model7, self).__init__(name, ['relational'], ['verify', 'single_choice'])
